                        ...
                        <div class="card-body p-4">
                            ...
                            <form method="POST" action="{{ route('password.email') }}">
                                ...
                                <div class="mb-3">
                                    ...
                                    <input class="form-control" placeholder="Nhập email của bạn" id="email" type="email" name="email" :value="old('email')" required autofocus>
                                </div>

                                <div class="text-center d-grid">
                                    <button class="btn btn-primary" onclick="loadchangemail(this)"><span id="loadmail" style="display: none;" class="spinner-border spinner-border-sm" role="status" aria-hidden="true"></span> Xác nhận email </button>
                                </div>
                            </form>
